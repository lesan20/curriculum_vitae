...
Осуществляла развитие данного направления с момента его создания и до релиза продукта -  [модуль для разработки систем мониторинга технического состояния оборудования](https://start.engee.com/monitoring).
  ...
  - Разработка [установки](https://exponenta.ru/events/predskazanie-otkazov-v-promishlenosi) для демонстрации технологии мониторинга и предсказательного обслуживания, включая проектирование установки и выбор компонентов. Установка включает асинхронные двигатели и набор датчиков. Выполнена сборка установки и организована система сбора данных. Созданы физические неисправности для формирования выборки. Обучены различные модели для демонстрации возможностей предсказательного обслуживания, включая:
      ...
      - Классификацию аномалий на ранней стадии с использованием вариационного автокодировщика (VAE).
...
AI: обработка Time Series, SVM, XGBoost trees, LSTM, Autoencoder, VAE.
  ...
  - Планирование фичей продукта, управление командой и мониторинг выполнения задач, отчетность
  - Реализация примеров пайплайнов разработки мониторинга на примере данных двигателей и трансформаторов
  - Разработка алгоритма непрерывной генерации данных реалистичного поведения
